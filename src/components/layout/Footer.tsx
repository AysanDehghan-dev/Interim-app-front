...
const FooterSection = styled.div`
  ...
  @media (max-width: 768px) {
    flex: 0 0 calc(50% - ${({ theme }) => theme.spacing.lg});
  }
    ...
    <FooterContainer>
      <FooterContent>
        <FooterSection>
          ...
          <Description>
            Votre plateforme de recrutement intérim innovante et intuitive. Trouvez les meilleurs talents ou opportunités professionnelles.
          </Description>
          <SocialLinks>
        ...
        <FooterSection>
          <FooterTitle>Pour les candidats</FooterTitle>
          <FooterLinks>
            <FooterLink>
              <StyledLink to="/jobs">
        ...
        <FooterSection>
          <FooterTitle>Pour les entreprises</FooterTitle>
          <FooterLinks>
            <FooterLink>
      ...
      <Copyright>
        &copy; {currentYear} InterimApp. Tous droits réservés. Propulsé par Flask et MongoDB.
      </Copyright>
    </FooterContainer>
  );
};
